...
from CloudPSS topology data and computing PCC Thevenin equivalents.
"""
...
def compute_positive_sequence_zth(model, renewable_bus: str, system_base_mva: float = 100.0) -> ZthResult:
    """
    ...
    for comp in pf_components.values():
        ...
        if bus_name_target and normalize_bus_name(bus_args.get("Name")) == bus_name_target:
            target_node = node

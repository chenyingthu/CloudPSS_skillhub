#!/usr/bin/env python3
"""
fault_clearing_scan Skill - Integration Tests

Tests for fault_clearing_scan skill with real CloudPSS API.
"""
...
class TestFaultClearingScanSkillIntegration:
    """Integration tests for fault_clearing_scan skill"""

    def setup_method(self):
        """Setup for each test"""
        self.skill = FaultClearingScanSkill()

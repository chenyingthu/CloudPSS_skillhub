...
class TestVoltageStabilityUnit:
    def test_extract_bus_voltages_matches_targets_from_real_rows(self):
        ...
        voltages = skill._extract_bus_voltages(
            result, ["canvas_0_1091", "canvas_0_1088"]
        )
    ...
    def test_run_fails_when_target_bus_voltages_cannot_be_extracted(
        ...
        job.result.getBuses.return_value = make_table(
            [{"Bus": "canvas_0_1", "Vm": 1.0}]
        )
        ...
        mock_model_utils_model.return_value = model

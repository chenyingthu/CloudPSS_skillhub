#!/usr/bin/env python3
"""
reactive_compensation_design Skill - Integration Tests

Tests for reactive_compensation_design skill with real CloudPSS API.
"""
...
class TestReactiveCompensationDesignSkillIntegration:
    """Integration tests for reactive_compensation_design skill"""

    def setup_method(self):
        """Setup for each test"""
        self.skill = ReactiveCompensationDesignSkill()
    ...
    def test_skill_registration(self):
        ...
        assert skill.name == "reactive_compensation_design"
    ...
    def test_integration_run_reactive_compensation_design(self, auth_token):
        """Test running reactive compensation design on IEEE3 model"""

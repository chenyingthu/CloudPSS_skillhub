'''EMT Simulation Skill v2 - Electromagnetic Transient Simulation.'''
...
class EMTSimulationSkill:
    """EMT (Electromagnetic Transient) simulation skill."""
    name = 'emt_simulation'
    description = 'Electromagnetic transient simulation'
